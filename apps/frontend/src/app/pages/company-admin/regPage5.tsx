...
const RegPage5 = (props: Props) => {
    ...
    const [warehouseManagerEmails, setWarehouseManagerEmails] = useState<string[]>([]);
    ...
    const deleteShopManagerEmail = (index: number) => {
        ...
        setShopManagerEmails((shopManagerEmails) => shopManagerEmails.filter((_, i) => i !== index));
        console.log('delete ' + index);
    };

    const deleteWarehouseManagerEmail = (index: number) => {
        setWarehouseManagerEmails((warehouseManagerEmails) => warehouseManagerEmails.filter((_, i) => i !== index));
    };

    const deleteProcurementManagerEmail = (index: number) => {
        setProcurementManagerEmails((procurementManagerEmails) => procurementManagerEmails.filter((_, i) => i !== index));
    };
                    ...
                    <Grid container item xs={12} spacing={1}>
                        ...
                        <Grid container item xs={12} md={4} sx={{ mt: 1 }} alignItems="center" justifyContent="space-evenly" direction="column">
                            ...
                            <Box sx={{ bgcolor: '#CBCBCB' }} style={{ maxHeight: 350, minHeight: 350, overflow: 'auto' }}>
                                ...
                                <EmailList emails={procurementManagerEmails} handleDelete={deleteProcurementManagerEmail} />
                            </Box>
                        </Grid>
                        {/* wm */}
                        <Grid container item xs={12} md={4} sx={{ mt: 1 }} alignItems="center" justifyContent="space-evenly" direction="column">
                            ...
                            <Box sx={{ bgcolor: '#CBCBCB' }} style={{ maxHeight: 350, minHeight: 350, overflow: 'auto' }}>
                                ...
                                <EmailList emails={warehouseManagerEmails} handleDelete={deleteWarehouseManagerEmail} />
                            </Box>
                        </Grid>
                        {/* SM */}
                        <Grid container item xs={12} md={4} sx={{ mt: 1 }} alignItems="center" justifyContent="space-evenly" direction="column">
                            ...
                            <Box sx={{ bgcolor: '#CBCBCB' }} style={{ maxHeight: 350, minHeight: 350, overflow: 'auto' }}>
                                ...
                                <EmailList emails={shopManagerEmails} handleDelete={deleteShopManagerEmail} />
                            </Box>
                        </Grid>
                    </Grid>

                    <Button variant="contained" className="createAcc" style={{ width: '25%', marginTop: '5%', alignSelf: 'center' }}>
                        Continue
