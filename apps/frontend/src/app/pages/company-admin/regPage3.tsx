              ...
              return (
                <Grid item xs={6}>
                      <DistributionStructure
                          id={distributionStructure[index].id}
                          name={distributionStructure[index].name}
                          description={distributionStructure[index].description}
                          img={distributionStructure[index].img}
