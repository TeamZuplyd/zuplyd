...
export function LandingFeatures(props: LandingFeaturesProps) {
  ...
  return (
    <Container sx={{ bgcolor: '#161C24', pt: 5, pb: 5, m: 0, minWidth: '100vw' }} id="features">
      <Container maxWidth="lg">
        <Grid container>
          <Grid item sm={12} md={6}>
            <Box display="flex" justifyContent="center" alignItems="flex-start" minHeight="60vh" sx={{ flexDirection: 'column' }} style={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" gutterBottom component="p" style={{ width: '70%', color: '#A5C1D9' }} align="left">
                A smarter way to supply chain management, no matter what business you’re in.
              </Typography>
              <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexDirection: 'column', mt: 6 }} style={fBox1} data-aos="fade">
          ...
          <Grid item sm={12} md={6}>
            <Box minHeight="60vh" style={{ position: 'relative' }}>
              <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexDirection: 'column', mt: 6 }} style={fBox2} data-aos="fade-down">
              ...
              <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexDirection: 'column', mt: 6, ...fBox3 }} data-aos="fade-left">
                <TaskIcon sx={{ color: '#FFF', fontSize: 63, mb: 2 }} />
              ...
              <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexDirection: 'row', mt: 6 }} style={fBox4} data-aos="fade-right">
                <div>
                  <Typography variant="h6" gutterBottom component="p" style={{ color: '#FFF' }} align="right">
              ...
              <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexDirection: 'column', mt: 6 }} style={fBox5} data-aos="fade-up">
