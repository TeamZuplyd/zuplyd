...
export interface WMOrderHistoryTableProps {
  orders: any[];
}

export function WMOrderHistoryTable({ orders }: WMOrderHistoryTableProps) {
      ...
      <Table stickyHeader sx={{ minWidth: 500 }} aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            ...
            <TableCell component="th">Request Type</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0 ? orders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : orders)
            ...
            .map((order) => (
              <TableRow key={order.item_code}>
                ...
                {/* correct this */}
                <TableCell style={{}}>Received</TableCell>
              </TableRow>
            ))}
          {emptyRows > 0 && (
...
export default WMOrderHistoryTable;
